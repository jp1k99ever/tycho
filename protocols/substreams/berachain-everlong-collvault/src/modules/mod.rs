...
pub(crate) mod config {
    ...
    pub struct VenueConfig {
        pub swapper: collvault::Address,
        pub rebalancer: collvault::Address,
        pub alm: collvault::Address,
        pub stable: collvault::Address,
        pub volatile: collvault::Address,
        ...
        pub fn parse(params: &str) -> Result<Self> {
                ...
                .filter(|part| !part.is_empty())
            {
                ...
                match key {
                    ...
                    _ => {
                        return Err(anyhow!("unknown Everlong CollVault Substreams param `{key}`"))
                    }
                }
            }
            Ok(config)
    ...
    impl VenueConfig {
        pub fn component_id(&self) -> String {
            collvault::component_id(self.swapper)
        }
    }

    fn parse_address(value: &str) -> Result<collvault::Address> {
        let trimmed = value
            .strip_prefix("0x")
            .unwrap_or(value);
